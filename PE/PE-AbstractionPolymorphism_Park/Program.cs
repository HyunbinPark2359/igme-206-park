...
namespace Abstraction_Polymorphism_Demo
{
    class Program
    {
        ...
        private static void ShapesDemo()
        {
            ...
            do
            {
                choice = GetPromptedInput("What type of shape do you want (circle, square, triangle, octagon, or Q to quit)?").ToUpper();
                switch (choice)
                {
                    ...
                    // Get the side length for a new triangle and add it to the list
                    case "TRIANGLE":
                        shapes.Add(new Triangle(GetPromptedPositiveDouble("What is the side length?")));
                        break;

                    // Get the side length for a new octagon and add it to the list
                    case "OCTAGON":
                        shapes.Add(new Octagon(GetPromptedPositiveDouble("What is the side length?")));
                        break;
        ...
        private static void PetsDemo()
        {
            ...
            {
                // We create pets in quintets: Cat, Dog, Duck, Bird, then Goat -- over and over
                ...
                {
                    pets[i] = new Goat(names[i], DateTime.Today);
                }
