...
namespace HW6_CritterFarm
{
    ...
    /// Store and track the data and status of a critter
    /// and make them possible to eat, play, etc.
    /// </summary>
    abstract class Critter
    {
        ...
        /// Although this method doesn't make sense in the parent class,
        /// I want all of the child class to override it.
        /// By making this method abstract, children classes can override it
        /// while preventing others from instantiating the base class
        /// </summary>
