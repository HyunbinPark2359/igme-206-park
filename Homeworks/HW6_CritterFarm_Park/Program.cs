...
namespace HW6_CritterFarm
{
    ...
    public class Program
    {
        ...
        static void TestCritters()
        {
            ...
            Dog d1 = new Dog("New Puppy");
            Horse h1 = new Horse("New Horse");
            Cat c2 = new Cat("Shiro", 10, 10);
            Dog d2 = new Dog("Pax", 10, 10);
            Horse h2 = new Horse("Aiden", 10, 10);
            
            // Add them to the list of critters
            List<Critter> critters = new List<Critter>() {c1, d1, h1, c2, d2, h2};
            ...
            // Call Eat, Play, Talk, and PassTime on each critter
            foreach (Critter c in critters)
            {
                c.Eat();
                c.Play();
                ...
                if (rng.Next(100) < 25 && c.Type == CritterType.Cat)
                {
                    Cat car = (Cat)c;
                    car.CauseMischief();
                }
